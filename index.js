...
// Defina aqui o link da música desejada:
const musicUrl = 'music/Feliz Aniversário.mp3'; // Troque para a música que quiser
    ...
    musicBtn.addEventListener('click', function() {
        ...
        if (isPlaying) {
            ...
            musicAudio.play().then(() => {
                ...
                alert('Não foi possível reproduzir a música automaticamente. Toque novamente ou verifique as permissões do navegador.');
            });
        }
        isPlaying = !isPlaying;
    });
